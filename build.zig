...
pub fn build(b: *std.Build) void {
    ...
    // Create the wtype library module with system library dependencies
    ...
    // Link system libraries for Wayland and XKB
    ...
    // Create a module for the library that can be imported
    const mod = b.addModule("wtype", .{
        .root_source_file = b.path("src/root.zig"),
        .target = target,
        .link_libc = true,
    });
    ...
    // Create the CLI executable that uses the wtype library
    ...
    // Add the wtype module as an import for the CLI
    exe.root_module.addImport("wtype", mod);
    ...
    mod_tests.linkLibC();
    mod_tests.root_module.addImport("wtype", mod);
    ...
    exe_tests.linkLibC();
    exe_tests.root_module.addImport("wtype", mod);
